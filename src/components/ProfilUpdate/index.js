            ...
            <div className="col-md-6 col-lg-4">
              <form className="mt-4">
                ...
                <div className="form-group mt-4">
                  ...
                  <input type="address" className="form-control" id="exampleInputAddress1" placeholder="Adresse" />
                </div>

                <div className="form-group mt-4">
                  <div className="d-flex justify-content-between" />

                  <input type="zipcode" className="form-control" id="exampleInputZipCode1" placeholder="Code postal" />
                </div>

                <div className="form-group mt-4">
                  <div className="d-flex justify-content-between" />

                  <input type="city" className="form-control" id="exampleInputCity1" placeholder="Ville" />
                </div>
